 ...
 * 时间： 2018/7/31
 *
 * 说明： 帧定义参考rpg_svo(https://github.com/uzh-rpg/rpg_svo) 参考冯兵博客 略作修改
 *************************************************************************/
#ifndef HC_VO_FRAME_H_
#define HC_VO_FRAME_H_
...
namespace hc_vo{
	...
	public:
		...
		/// 二维点对六维变换李代数的雅克比矩阵，具体推导可以参考(https://blog.csdn.net/zhubaohua_bupt/article/details/74011005),但是差负号
	...
	private:
		...
		void createImgPyramid(const cv::Mat& img_level_0, int n_levels, ImgPyr& pyr);
                void halfSample(cv::Mat& img_l, cv::Mat& img_h);
	...
	namespace frame_utils {
		...
		bool getSceneDepth(const Frame& frame, double& depth_mean, double& depth_min);
                double getMedian(std::vector<double>& depth_vec);
	} // namespace frame_utils
	typedef std::shared_ptr<Frame> FramePtr;
}

#endif // HC_VO_FRAME_H_
