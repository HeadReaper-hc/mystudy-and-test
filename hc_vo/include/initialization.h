 ...
 * 时间： 2018/8/5
 *
 * 说明： 初始化，确定初始位置，参考rpg_svo(https://github.com/uzh-rpg/rpg_svo)  馮兵博客
 *************************************************************************/
#ifndef HC_VO_INITIALIZATION_H_
#define HC_VO_INITIALIZATION_H_
