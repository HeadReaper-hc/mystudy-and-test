# 导入Eigen库
# ===================================================
SET(EIGEN_EMBEDDED_INCLUDE_DIR "${PROJECT_SOURCE_DIR}/3rdparty/eigen3/" CACHE PATH "Eigen path for embedded use")
...
IF (EIGEN_USE_EMBEDDED_VERSION)
	# 获得内部版本的include目录:
	SET(EIGEN_INCLUDE_DIR "${EIGEN_EMBEDDED_INCLUDE_DIR}")
ELSE(EIGEN_USE_EMBEDDED_VERSION)
	...
	ELSE(NOT PKG_CONFIG_FOUND)
		...
		IF(PKG_EIGEN3_FOUND)
			SET(EIGEN_INCLUDE_DIR "${PKG_EIGEN3_INCLUDE_DIRS}")
...
IF(EXISTS "${EIGEN_INCLUDE_DIR}/unsupported/")
	INCLUDE_DIRECTORIES("${EIGEN_INCLUDE_DIR}/unsupported/")
ENDIF(EXISTS "${EIGEN_INCLUDE_DIR}/unsupported/")
...
IF (EXISTS ${EIGEN_VER_H})
	...
	SET(EIGEN_VERSION "${CMAKE_EIGEN_VERSION_NUMBER_MAJOR}.${CMAKE_EIGEN_VERSION_NUMBER_MINOR}.${CMAKE_EIGEN_VERSION_NUMBER_PATCH}")
